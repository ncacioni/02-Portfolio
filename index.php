...
<body>
    ...
    <nav class="navbar">
        <div class="max-width">
            <div class="logo"><a href="#">Caci<span>oni.</span></a></div>
            <ul class="menu">
    ...
    <section class="home" id="home">
        <div class="max-width">
            <div class="home-content">
                ...
                <div class="text-2">Nahuel G. Cacioni</div>
                <div class="text-3">Y soy un <span class="typing"></span></div>
                <a href="#contact">Contrátame</a>
            </div>
        </div>
    </section>
    <!-- about section start -->
    <section class="aboutsp about" id="about">
        <div class="max-width">
            ...
            <div class="about-content">
                ...
                <div class="column right">
                    <div class="text">Soy Nahuel y soy un <span class="typing-2"></span></div>
                    <p>Mi nombre es Nahuel Gustavo Cacioni. Soy un desarrollador full-stack, diseñador y profesional del
                        marketing digital. Resido en Buenos Aires, Argentina. Amo los animales, la música, el café, las
                        infusiones y la tecnología.
                        <br><br>
                        Mi meta es lograr cumplir los objetivos de mis clientes, realizando un seguimiento y feed-back
                        constante. Mi forma de trabajo es colaborativa: tanto cliente como profesional son un conjunto
                        indivisible que logra objetivos.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="servicessp services" id="services">
        <div class="max-width">
            ...
            <div class="serv-content">
                <div class="card">
                    <div class="box">
                        ...
                        <p>Hago realidad tu sueño web. Trabajamos juntos en conseguir objetivos acorde a tus
                            necesidades. Cada trabajo es único, e irrepetible.</p>
                    </div>
                </div>
                <div class="card">
                    <div class="box">
            ...
            <div class="serv-content">
                <a href="https://ncacioni.github.io/React-Calculator/" class="project-card card project01">
                    <div class="box">
                        ...
                        <p>Calculadora básica realizada en React</p>
                        <div class="techs">
        ...
        <div class="max-width">
            ...
            <div class="contact-content">
                <div class="column left">
                    ...
                    <p>Envíame un mail para contactarte conmigo. Consultas sobre presupuestos, quejas y sugerencias o
                    ...
                    <div class="icons">
                        <div class="row">
                            ...
                            <div class="info">
                                ...
                                <div class="sub-title">Nahuel G. Cacioni</div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="info">
                                ...
                                <div class="sub-title">nahuel@cacioni.com</div>
                            </div>
                        </div>
                    </div>
                </div>
...
?>
    ...
    <footer>
        <span>Creado Por <a href="https://www.cacioni.com">Cacioni</a> | <span class="far fa-copyright"></span> 2022
